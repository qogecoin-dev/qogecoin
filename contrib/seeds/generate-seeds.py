...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef QOGECOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define QOGECOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the qogecoin network\n')
    ...
    g.write('#endif // QOGECOIN_CHAINPARAMSSEEDS_H\n')
