...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the qogecoin repository."
  exit 1
fi
...
# See https://github.com/qogecoin/qogecoin/issues/16064
...
echo 'When compiling qogecoind, run `./configure` in the following way:'
echo
