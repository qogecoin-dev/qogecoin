...
#ifndef QOGECOIN_WALLET_WALLETUTIL_H
#define QOGECOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! qogecoin from opening the wallet, thinking it was newly created, and
...
#endif // QOGECOIN_WALLET_WALLETUTIL_H
