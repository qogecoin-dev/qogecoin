 ...
 *  A CTxDestination is the internal data type encoded in a qogecoin address
 */
...
/**
 * Generate a Qogecoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // QOGECOIN_SCRIPT_STANDARD_H
