    ...
    mapper(nullptr)
{
    ...
    ui->unit->setModel(new QogecoinUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSQogeontrols);
...
void OptionsDialog::on_openQogecoinConfButton_clicked()
{
