...
#ifndef QOGECOIN_QT_QOGECOINUNITS_H
#define QOGECOIN_QT_QOGECOINUNITS_H
...
/** Qogecoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class QogecoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit QogecoinUnits(QObject *parent);
