...
/** Interface from Qt to configuration data structure for Qogecoin client.
...
public:
    ...
    bool getEnablePSQogeontrols() const { return m_enable_psbt_controls; }
