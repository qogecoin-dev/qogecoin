...
void AppTests::appTests()
{
    ...
    connect(&m_app, &QogecoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for QogecoinGUI tests.
void AppTests::guiTests(QogecoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &QogecoinGUI::consoleShown, this, &AppTests::consoleTests);
