...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<QogecoinAmountField*>("payAmount")->setValue(amount);
...
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = QogecoinUnits::formatWithUnit(unit, balance, false, QogecoinUnits::SeparatorStyle::ALWAYS);
    ...
    // Amount input
    QogecoinAmountField* amountInput = receiveCoinsDialog.findChild<QogecoinAmountField*>("reqAmount");
