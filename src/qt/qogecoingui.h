...
/**
  Qogecoin GUI main class. This class represents the main window of the Qogecoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class QogecoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit QogecoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~QogecoinGUI();
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, QogecoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Qogecoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(QogecoinUnit newUnits);
