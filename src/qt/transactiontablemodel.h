...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, QogecoinUnits::SeparatorStyle separators=QogecoinUnits::SeparatorStyle::STANDARD) const;
