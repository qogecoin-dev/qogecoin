...
/** Main Qogecoin application object */
class QogecoinApplication: public QApplication
{
    Q_OBJECT
public:
    explicit QogecoinApplication();
    ~QogecoinApplication();
    ...
    /// Get window identifier of QMainWindow (QogecoinGUI)
...
Q_SIGNALS:
    ...
    void splashFinished();
    void windowShown(QogecoinGUI* window);
