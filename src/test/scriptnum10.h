...
#ifndef QOGECOIN_TEST_SCRIPTNUM10_H
#define QOGECOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Qogecoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // QOGECOIN_TEST_SCRIPTNUM10_H
