// Copyright (c) 2015-2018 The Bitcoin and Qogecoin Core Authors
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef QOGECOIN_CORE_MEMUSAGE_H
#define QOGECOIN_CORE_MEMUSAGE_H
...
#endif // QOGECOIN_CORE_MEMUSAGE_H
