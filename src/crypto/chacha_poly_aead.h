...
#ifndef QOGECOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define QOGECOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@qogecoin.
 *
 ...
 *
 * The chacha20-poly1305@qogecoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@qogecoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@qogecoin are relatively fast in
...
#endif // QOGECOIN_CRYPTO_CHACHA_POLY_AEAD_H
