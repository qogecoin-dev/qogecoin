...
#ifndef QOGECOIN_COMPAT_ASSUMPTIONS_H
#define QOGECOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Qogecoin cannot be compiled without assertions."
#endif
...
#endif // QOGECOIN_COMPAT_ASSUMPTIONS_H
