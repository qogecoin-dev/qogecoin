...
class TxnMallTest(QogecoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 Qoge:
        ...
        # First: use raw transaction API to send 1240 Qoge to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 Qoge coin each
        ...
        # Node0's balance should be starting balance, plus 50Qoge for another
        ...
        # Node0's total balance should be starting balance, plus 100Qoge for
