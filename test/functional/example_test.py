...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the QogecoinTestFramework
    pass


class ExampleTest(QogecoinTestFramework):
    # Each functional test is a subclass of the QogecoinTestFramework class.
    ...
    def custom_method(self):
        ...
        QogecoinTestFramework class so other tests can use it."""
