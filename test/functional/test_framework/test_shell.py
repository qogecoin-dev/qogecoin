...
class TestShell:
    """Wrapper Class for QogecoinTestFramework.

    The TestShell class extends the QogecoinTestFramework
    ...
    class __TestShell(QogecoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by QogecoinTestFramework child class.
            self.num_nodes = 1
