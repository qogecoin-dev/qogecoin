...
"""
Test starting qogecoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(QogecoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that qogecoind has bound on "::1" (for RPC) and "::" (for P2P).
