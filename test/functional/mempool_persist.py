...
By default, qogecoind will dump mempool on shutdown and
...
class MempoolPersistTest(QogecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent qogecoind from writing mempool.dat to disk. Verify that `savemempool` fails")
