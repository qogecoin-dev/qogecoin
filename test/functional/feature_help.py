...
"""Verify that starting qogecoin with -h works as expected."""

from test_framework.test_framework import QogecoinTestFramework
from test_framework.util import assert_equal

class HelpTest(QogecoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start qogecoin with -h for help text")
        ...
        self.log.info("Start qogecoin with -version for version information")
        ...
        self.log.info("Start qogecoind with -fakearg to make sure it does not start")
