...
Assumeutxo is a feature that allows fast bootstrapping of a validating qogecoind
...
- [Github issue](https://github.com/qogecoin/qogecoin/issues/15605)
- [draft PR](https://github.com/qogecoin/qogecoin/pull/15606)
...
considered active. This is the "traditional" mode of operation for qogecoind.
...
**Failure consideration:** if qogecoind unexpectedly halts after `m_stop_use` is set on
...
### Qogecoind restarts sometime after snapshot validation has completed

When qogecoind initializes again, what began as the snapshot chainstate is now
