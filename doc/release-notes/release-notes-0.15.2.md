Qogecoin Core version *0.15.2* is now available from:

  <https://qogecoincore.org/bin/qogecoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in qogecoin-tx (TheBlueMatt)
