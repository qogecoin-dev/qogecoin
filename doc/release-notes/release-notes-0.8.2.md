...
The default fee for low-priority transactions is lowered from 0.0005 Qoge 
(for each 1,000 bytes in the transaction; an average transaction is
about 500 bytes) to 0.0001 Qoge.

Payments (transaction outputs) of 0.543 times the minimum relay fee
(0.00005430 Qoge) are now considered 'non-standard', because storing them
...
* Entering the 'getblocktemplate' or 'getwork' RPC commands into the Qogecoin-Qt debug
console will cause Qogecoin-Qt to crash. Run Qogecoin-Qt with the -server command-line
