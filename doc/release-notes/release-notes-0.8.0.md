Qogecoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/qogecoin/files/Qogecoin/qogecoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Qogecoin
...
New/changed settings (command-line or qogecoin.conf file)
--------------------------------------------------------
