Qogecoin Core version 0.9.4 is now available from:

  https://qogecoin.org/bin/0.9.4/
...
this update is incompatible with the Qogecoin system and could lead to consensus
forks.

Qogecoin Core released binaries from https://qogecoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~qogecoin/+archive/ubuntu/qogecoin
- A third-party or self-compiled Qogecoin Core

upgrade to Qogecoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
