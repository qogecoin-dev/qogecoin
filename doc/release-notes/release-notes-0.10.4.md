Qogecoin Core version 0.10.4 is now available from:

  <https://qogecoin.org/bin/qogecoin-core-0.10.4/>
...
- #6953 `43c2789` Split qogecoin-tx into its own package
- #6953 `dfe0d4d` Include qogecoin-tx binary on Debian/Ubuntu
