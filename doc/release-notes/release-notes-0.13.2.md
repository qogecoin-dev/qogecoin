Qogecoin Core version 0.13.2 is now available from:

  <https://qogecoin.org/bin/qogecoin-core-0.13.2/>
...
- #8908 `4a974b2` Update qogecoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow qogecoin-tx to create v2 transactions (btcdrak)
