...
Qogecoin Core version 0.19.1 is now available from:

  <https://qogecoincore.org/bin/qogecoin-core-0.19.1/>
...
From Qogecoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Qogecoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Qogecoin Core does not yet change appearance when
...
- #17488 fix "qogecoind already running" warnings on macOS (fanquake)
