Qogecoin Core version 0.9.2.1 is now available from:

  https://qogecoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 Qoge to 0.01 Qoge
...
- Fix "Start qogecoin on system login"
