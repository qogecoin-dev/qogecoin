...
Note
---------------------
Always use absolute paths to configure and compile Qogecoin Core and the dependencies.
...
To build Qogecoin Core without wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Otherwise, you can build Qogecoin Core from self-compiled [depends](/depends/README.md).

**Note**: You only need Berkeley DB if the legacy wallet is enabled (see [*Disable-wallet mode*](#disable-wallet-mode)).

Security
--------
To help make your Qogecoin Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, Qogecoin Core should be built with a non-executable stack,
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, Qogecoin Core can
