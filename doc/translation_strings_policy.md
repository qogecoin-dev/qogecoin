...
This document provides guidelines for internationalization of the Qogecoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `qogecoin_en.ts` remains unchanged.
